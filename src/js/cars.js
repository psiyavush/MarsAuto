...
let carContent = document.querySelector('.car__content');

// Делаем запрос в функции на получения списка авто из БД и выводим первые три
const getAllCars = () => {
    ...
    .then((cars) => {
        ...
        <div class="car__content-card">
                        <img src="${item.image}" class="car__content-img" alt="${item.title}">
